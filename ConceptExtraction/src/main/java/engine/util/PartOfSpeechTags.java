...
/**
 * Represents the English parts-of-speech, encoded using the de facto <a
 * href="http://www.cis.upenn.edu/~treebank/">Penn Treebank Project</a>
 * standard.
 * 
 * @see <a href="ftp://ftp.cis.upenn.edu/pub/treebank/doc/tagguide.ps.gz">Penn
 *      Treebank Specification</a>
 */
public enum PartOfSpeechTags {
	ADJECTIVE("JJ"), ADJECTIVE_COMPARATIVE(ADJECTIVE + "R"), ADJECTIVE_SUPERLATIVE(
			ADJECTIVE + "S"),
	 ...
	 */
	CONJUNCTION_COORDINATING("CC"), CONJUNCTION_SUBORDINATING("IN"), CARDINAL_NUMBER(
			"CD"), DETERMINER("DT"),
	...
	NOUN("NN"), NOUN_PLURAL(NOUN + "S"), NOUN_PROPER_SINGULAR(NOUN + "P"), NOUN_PROPER_PLURAL(
			NOUN + "PS"),
	...
	VERB("VB"), VERB_PAST_TENSE(VERB + "D"), VERB_PARTICIPLE_PRESENT(VERB + "G"), VERB_PARTICIPLE_PAST(
			VERB + "N"), VERB_SINGULAR_PRESENT_NONTHIRD_PERSON(VERB + "P"), VERB_SINGULAR_PRESENT_THIRD_PERSON(
			VERB + "Z"),
	...
	private PartOfSpeechTags(String tag) {
		this.tag = tag;
	}
	...
	public static PartOfSpeechTags get(String value) {
		for (PartOfSpeechTags v : values()) {
